    ...
    <div class="container">
        ...
        <div class="form-container">
            <a href="index.php" style="text-decoration: none;">
                <h1 class="foodnow-title">FoodNow</h1>
            </a>
            ...
            <div class="social-login-buttons">
                ...
                <a href="#" class="btn-social btn-facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
                        <path d="M41,4H9C6.24,4,4,6.24,4,9v32c0,2.76,2.24,5,5,5h32c2.76,0,5-2.24,5-5V9C46,6.24,43.76,4,41,4z" fill="#1877f2" />
                        <path d="M34.5,25H31v16h-6V25h-4v-5h4v-3.9c0-4.33,1.96-7.1,6.54-7.1C33.17,9,34.8,9.22,35,9.26V14h-2.8c-1.81,0-2.2,0.85-2.2,2.34V20h5L34.5,25z" fill="#fff" />
                    </svg>
                    Facebook
                </a>
            </div>
