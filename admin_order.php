    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li class="active"><a href="admin_order.php"><i class="fas fa-receipt"></i> <span>Quản lý Đơn hàng</span></a></li>
        ...
        <main class="main-content">
            <header class="main-header">
                ...
                <input type="search" id="admin-search-user" placeholder="Tìm kiếm đơn hàng..." autocomplete="off">
